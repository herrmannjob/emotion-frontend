    ...
    <div class="header-wrapper flex bg-white justify-between px-4">
        <div class="flex items-center">
            <div class="logo flex justify-center">
                ...
                <img width="80"
                    height="80"
                    viewBox="0 0 80 80" src="../../public/images/logo.png" alt="logo"/>
            </div>
        ...
        <div class="flex items-center">
            ...
            <Menu as="div" class="relative inline-block text-left">
                <div>
                    <MenuButton
                        class="flex mr-3 text-sm rounded-full md:mr-0 focus:ring-2 focus:ring-purple-300 dark:focus:ring-purple-600"
                    >
                        <img
