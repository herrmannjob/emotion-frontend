<template>
    <div
        class="border-2 border-purple-300 shadow-xl overflow-hidden sm:rounded-md md:mx-30 h-auto p-8 mb-8"
    >
        <!--      Tool Bar      -->
            ...
            >
                <div @click.self="clickOnInput()" class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600">
                        <label
                            for="file-upload"
                            class="relative cursor-pointer bg-white rounded-md font-medium text-purple-500 hover:text-purple-600 transition-color duration-300"
                        >
                            <span>Envie um arquivo</span>
                            <input
                                multiple
                                @change="clickedInput($event)"
                                id="file-upload"
                                name="file-upload"
                                type="file"
                                class="sr-only"
